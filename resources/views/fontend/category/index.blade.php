                ...
                <div class="col-lg-9">
                    ...
                    <div class="shop_content">
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count"><span>{{-- {{ $product }} --}}</span> products </div>
                            ...
                            @foreach($product_cate as $product_cate)
                                <div class="product_item">
                                    ...
                                    <div class="product_content">
                                        <div class="product_price">${{ $product_cate->origin_price }}</div>
                                        <div class="product_name"><div><a href="#" tabindex="0">{{ $product_cate->name }}</a></div></div>
                                    </div>
