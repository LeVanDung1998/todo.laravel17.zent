...
@section('content')
   {{--  <div class="banner">
    ...
    <div class="banner" style="padding-top:0;padding-bottom: 0;">
     <div class="swiper-container">
        <div class="swiper-wrapper">
            @foreach ($slides as $slide)
                <div class="swiper-slide" style="background-image:url('/storage/{{ $slide->path }}');padding-top: 44%;background-size: cover;background-repeat: no-repeat;background-position: center;"></div>
            @endforeach
