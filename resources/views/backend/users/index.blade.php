                               ...
                               @foreach($users as $user)
                                   <tr>
                                        ...
                                        <td>
                                            ...
                                            <a style="display: inline-block; width: 40px;" href="{{ route('backend.user.edit',$user->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                            <a class="btn btn-danger" style="display: inline-block; width: 40px;" href="{{ route('backend.user.destroy', $user->id) }}" data-toggle="modal" data-target="#exampleModalCenter-{{$user->id}}"><i class="fas fa-trash-alt"></i></a>
